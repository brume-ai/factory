...
assert_contains "$liv" 'arbitré par l'\''orchestrateur : suite' "l'\''arbitrage, depuis arbitrage.md"
assert_contains "$liv" 'est porté par la carte de suite #77' "la carte de suite, depuis suite.md"
